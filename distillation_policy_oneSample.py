...
# replay_buffer1 = torch.load('/home/user/amania1/DRL-robot-navigation/TD3/pytorch_models/replay_buffer_part1.pth')
replay_buffer2 = torch.load('/home/user/amania1/DRL-robot-navigation/TD3/pytorch_models/replay_buffer_part2.pth')
...
def train(data_batch_camera, data_batch_scan):
    ...
    if TRAIN_STEP % 2 == 0: #if it is even, then set the camera data to the model
        ...
        writer.add_scalar('encoded_features_camera/TRAIN', encoded_features.mean().item(), TRAIN_STEP)
        ...
        with torch.no_grad():
            ...
            writer.add_scalar('L1_LOSS_CAMERA/TRAIN', loss_l1_camera, TRAIN_STEP)
        ...
        #pass the features to the encoder
        encoded_features = model_encoder(features)
        writer.add_scalar('encoded_features_scan/TRAIN', encoded_features.mean().item(), TRAIN_STEP)
        ...
        with torch.no_grad():
            ...
            writer.add_scalar('L1_LOSS_SCAN/TRAIN', loss_l1_scan, TRAIN_STEP)
